...
Flappy Pingüino → Iceberg Quest: Vuelo entre estalactitas

Endless Runner → Iceberg Quest: Carrera sobre el hielo

Shooter lateral → Iceberg Quest: Batalla contra androides
...
Click con el mouse sobre el canvas → también hace que el pingüino salte.
...
Evita chocar con los bloques de hielo.
...
Evita chocar con los obstáculos rojos.
...
Espacio → bajar el anzuelo.

Si atrapas un pez naranja → +10 puntos.
